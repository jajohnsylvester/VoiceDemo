...
const VoiceCard: React.FC<VoiceCardProps> = ({ voice, isPlaying, onPlayToggle, onAnimate }) => {
            ...
            <div className="flex gap-2 items-center">
                {onAnimate && (
                    <button 
                        ...
                        className="p-1.5 hover:bg-zinc-100 dark:hover:bg-zinc-700 rounded-lg transition-colors group/btn"
                        title="Animate character"
                    >
                        <Sparkles size={14} className="text-indigo-500 group-hover/btn:scale-110 transition-transform" />
                    </button>
                )}
