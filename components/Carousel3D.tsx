...
import { Play, Pause, Activity, ChevronLeft, ChevronRight, Sparkles } from 'lucide-react';
                                  ...
                                  <div className="flex gap-2">
                                      {onAnimate && (
                                          <button 
                                              ...
                                              className="p-1.5 hover:bg-zinc-100 dark:hover:bg-zinc-700 rounded-lg transition-colors group/animate"
                                              title="Animate this character"
                                          >
                                              <Sparkles size={16} className="text-indigo-500 group-hover/animate:scale-110 transition-transform" />
                                          </button>
                                      )}
